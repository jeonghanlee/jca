 ...
 *
 *
 * $Id: CAStatus.java,v 1.1.1.1 2004/02/16 15:59:05 boucher Exp $
 *
 */
...
public class CAStatus extends gov.aps.jca.ValuedEnum {
  ...
  static public final CAStatus ARRAY16KCLIENT= new CAStatus("ARRAY16KCLIENT", 58, CASeverity.WARNING, "");
  static public final CAStatus CONNSEQTMO= new CAStatus("CONNSEQTMO", 59, CASeverity.WARNING, "");
