 ...
 *
 *
 * $Id: Context.java,v 1.2 2004/03/31 09:14:11 boucher Exp $
 *
 * Modification Log:
...
public abstract class Context {
   ...
   * @throws java.lang.IllegalStateException if the context has been destroyed.
   */
  abstract public Channel createChannel(String name, ConnectionListener l) throws CAException, IllegalStateException;
