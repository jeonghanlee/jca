 ...
 *
 *
 * $Id: JNI.java,v 1.3 2004/03/31 09:14:11 boucher Exp $
 *
 * Modification Log:
...
class JNI {
  ...
  static private void loadLibrary(String path, String lib) {
    if(path.equals("")) {
      ...
      try {
        ...
        if(libname.endsWith(".jnilib")) libname= lib.replaceFirst(".jnilib$", ".so");
  ...
  static public int ctxt_contextCreate( boolean preemptive_callback ) throws JNIException {
    synchronized( _lock ) {
...
//    }
  ...
  static public void ctxt_attachThread( int ctxtID ) throws JNIException {
//    synchronized( _lock ) {
      _ctxt_attachThread( ctxtID );
//    }
  }
  
  static public int ch_channelCreate( String name,
  JNIConnectionCallback callback ) throws
  JNIException {
    synchronized( _lock ) {
      return _ch_channelCreate( name, callback );
    }
  }
  
  static public void ch_channelDestroy( int channelID ) throws JNIException {
//    synchronized( _lock ) {
      _ch_channelDestroy( channelID );
//    }
  }
  
  static public void ch_setConnectionCallback( int channelID,
  JNIConnectionCallback callback ) throws
  JNIException {
//    synchronized( _lock ) {
...
//    }
  ...
  static public void ch_setAccessRightsCallback( int channelID,
...
//    }
  ...
  static public int ch_getFieldType( int channelID ) {
//    synchronized( _lock ) {
      return _ch_getFieldType( channelID );
//    }
  }
  
  static public int ch_getElementCount( int channelID ) {
//    synchronized( _lock ) {
      return _ch_getElementCount( channelID );
//    }
  }
  
  static public int ch_getState( int channelID ) {
//    synchronized( _lock ) {
      return _ch_getState( channelID );
//    }
  }
  
  static public String ch_getHostName( int channelID ) {
//    synchronized( _lock ) {
      return _ch_getHostName( channelID );
//    }
  }
  
  static public boolean ch_getReadAccess( int channelID ) {
//    synchronized( _lock ) {
      return _ch_getReadAccess( channelID );
//    }
  }
  
  static public boolean ch_getWriteAccess( int channelID ) {
//    synchronized( _lock ) {
      return _ch_getWriteAccess( channelID );
//    }
  }
  
  static public void ch_arrayPut( int type, int count, int channelID, int dbrID ) throws
  JNIException {
//    synchronized( _lock ) {
...
//    }
  ...
  static public void ch_arrayPutCallback( int type, int count, int channelID,
  int dbrID, JNIPutCallback callback ) throws
  JNIException {
//    synchronized( _lock ) {
...
//    }
  ...
  static public void ch_arrayGet( int type, int count, int channelID, int dbrID ) throws
  JNIException {
//    synchronized( _lock ) {
...
//    }
  ...
  static public void ch_arrayGetCallback( int type, int count, int channelID,
...
//    }
  ...
  static public int ch_addMonitor( int type, int count, int channelID,
...
//    }
  ...
  static public void ch_clearMonitor( int monitorID ) throws JNIException {
//    synchronized( _lock ) {
      _ch_clearMonitor( monitorID );
//    }
  }
  
  static public int dbr_create( int type, int count ) {
//    synchronized( _lock ) {
      return _dbr_create( type, count );
//    }
  }
  
  static public void dbr_destroy( int dbrid ) {
//    synchronized( _lock ) {
      _dbr_destroy( dbrid );
//    }
  }
  
  static public void dbr_setValue( int dbrid, int type, int count, Object value ) {
//    synchronized( _lock ) {
      _dbr_setValue( dbrid, type, count, value );
//    }
  }
  
  static public Object dbr_getValue( int dbrid, int type, int count,
  Object value ) {
//    synchronized( _lock ) {
...
//    }
  ...
  static public short dbr_getStatus( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getStatus( dbrid, type );
//    }
  }
  
  static public short dbr_getSeverity( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getSeverity( dbrid, type );
//    }
  }
  
  static public Number dbr_getUDL( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getUDL( dbrid, type );
//    }
  }
  
  static public Number dbr_getLDL( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getLDL( dbrid, type );
//    }
  }
  
  static public Number dbr_getUAL( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getUAL( dbrid, type );
//    }
  }
  
  static public Number dbr_getUWL( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getUWL( dbrid, type );
//    }
  }
  
  static public Number dbr_getLWL( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getLWL( dbrid, type );
//    }
  }
  
  static public Number dbr_getLAL( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getLAL( dbrid, type );
//    }
  }
  
  static public Number dbr_getUCL( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getUCL( dbrid, type );
//    }
  }
  
  static public Number dbr_getLCL( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getLCL( dbrid, type );
//    }
  }
  
  static public short dbr_getPrecision( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getPrecision( dbrid, type );
//    }
  }
  
  static public TimeStamp dbr_getTimeStamp( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getTimeStamp( dbrid, type );
//    }
  }
  
  static public String[] dbr_getLabels( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getLabels( dbrid, type );
//    }
  }
  
  static public String dbr_getUnits( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getUnits( dbrid, type );
//    }
  }
  
  static public int dbr_getAckT( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getAckT( dbrid, type );
//    }
  }
  
  static public int dbr_getAckS( int dbrid, int type ) {
//    synchronized( _lock ) {
      return _dbr_getAckS( dbrid, type );
//    }
  }
  
  static public void dbr_update( DBR dbr, int dbrid ) {
...
//    synchronized( _lock ) {
      ...
      if( dbr instanceof ACK ) {
        ( ( ACK )dbr ).setAckT( _dbr_getAckT( dbrid, type ) );
        ( ( ACK )dbr ).setAckS( _dbr_getAckS( dbrid, type ) );
      }
//    }
  }
  ...
  static native private int _ctxt_contextCreate( boolean preemptive_callback ) throws
  JNIException;
  ...
  static native private void _ctxt_attachThread( int ctxtID ) throws
  JNIException;
  
  static native private int _ch_channelCreate( String name,
  JNIConnectionCallback callback ) throws
  JNIException;
  
  static native private void _ch_channelDestroy( int channelID ) throws
  JNIException;
  
  static native private void _ch_setConnectionCallback( int channelID,
  JNIConnectionCallback callback ) throws JNIException;
  
  static native private void _ch_setAccessRightsCallback( int channelID,
  JNIAccessRightsCallback callback ) throws JNIException;
  
  static native private int _ch_getFieldType( int channelID );
  
  static native private int _ch_getElementCount( int channelID );
  
  static native private int _ch_getState( int channelID );
  
  static native private String _ch_getHostName( int channelID );
  
  static native private boolean _ch_getReadAccess( int channelID );
  
  static native private boolean _ch_getWriteAccess( int channelID );
  
  static native private void _ch_arrayPut( int type, int count, int channelID,
  int dbrID ) throws JNIException;
  
  static native private void _ch_arrayPutCallback( int type, int count,
  int channelID, int dbrID, JNIPutCallback callback ) throws JNIException;
  
  static native private void _ch_arrayGet( int type, int count, int channelID,
  int dbrID ) throws JNIException;
  
  static native private void _ch_arrayGetCallback( int type, int count,
  int channelID, JNIGetCallback callback ) throws JNIException;
  
  static native private int _ch_addMonitor( int type, int count, int channelID,
  JNIMonitorCallback callback,
  int mask ) throws JNIException;
  
  static native private void _ch_clearMonitor( int monitorID ) throws
  JNIException;
  
  static native private int _dbr_create( int type, int count );
  
  static native private void _dbr_destroy( int dbrid );
  
  static native private void _dbr_setValue( int dbrid, int type, int count,
  Object value );
  
  static native private Object _dbr_getValue( int dbrid, int type, int count,
  Object value );
  
  static native private short _dbr_getStatus( int dbrid, int type );
  
  static native private short _dbr_getSeverity( int dbrid, int type );
  
  static native private Number _dbr_getUDL( int dbrid, int type );
  
  static native private Number _dbr_getLDL( int dbrid, int type );
  
  static native private Number _dbr_getUAL( int dbrid, int type );
  
  static native private Number _dbr_getUWL( int dbrid, int type );
  
  static native private Number _dbr_getLWL( int dbrid, int type );
  
  static native private Number _dbr_getLAL( int dbrid, int type );
  
  static native private Number _dbr_getUCL( int dbrid, int type );
  
  static native private Number _dbr_getLCL( int dbrid, int type );
  
  static native private short _dbr_getPrecision( int dbrid, int type );
  
  static native private TimeStamp _dbr_getTimeStamp( int dbrid, int type );
  
  static native private String[] _dbr_getLabels( int dbrid, int type );
  
  static native private String _dbr_getUnits( int dbrid, int type );
  
  static native private int _dbr_getAckT( int dbrid, int type );
  
  static native private int _dbr_getAckS( int dbrid, int type );
