 ...
 *
 *
 * $Id: JNIChannel.java,v 1.2 2004/02/20 11:11:03 boucher Exp $
 *
 * Modification Log:
...
public class JNIChannel extends Channel {
  ...
  protected JNIChannel(JNIContext context, String name, ConnectionListener l) {
    _jnicontext= context;
    _name= name;
    if(l!=null) {
   ...
   *
   * @exception IllegalOperationException is thrown if the process variable has been disposed.
   **/
