 ...
 *
 *
 * $Id: JNIContextExceptionCallback.java,v 1.1.1.1 2004/02/16 15:59:06 boucher Exp $
 *
 * Modification Log:
...
class JNIContextExceptionCallback extends JNICallback {
  ...
  public void fire( int channelID, int type, int count, int dbrID, String status, String ctxtInfo, String file, int line ) {
    Channel ch=null;
    if( channelID!=0 ) {
